...
namespace NumericalMethods.Tests
{
    ...
    public class Numerical_Tests
    {
        ...
        [TestMethod]
        public void ZerothRootOfNumberExpectedArgumentException()
        {
            int num = 30;
            int pow = 0;
            double e = 0.001;
            ...
            {
                Assert.AreEqual("0-th root of number doesn't exist.", ae.Message);
            }
        }
        ...
        [TestMethod]
        public void OddNthRootOfPositiveNumberWithGivenAccuracyExpectedCorrectValue()
        {
            int num = 15;
            int pow = 7;
            double e = 0.0001;
        ...
        [TestMethod]
        public void OddNthRootOfNegativeNumberWithGivenAccuracyExpectedCorrectValue()
        {
            int num = -15;
            int pow = 7;
            double e = 0.0001;
